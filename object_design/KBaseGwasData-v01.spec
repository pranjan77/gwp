  ...
  */ 
   ...
   */
   ...
   /* GwasPopulationKinship has population kinship matrix
      ...
      data is the data table for the kinship matrix


     Search indexing: Donot index --> data
                    : index GwasPopulationVariation_obj_id (GwasPopulation_obj_id)
   */
   ...
   */
   ...
   typedef structure {
      ...
      string source; 
      string protocol; 
      string GwasPopulationTrait_obj_id; 
      ...
      list <tuple < int id, int position, float minus_log_pvalue, string pvalue>> variations;
      string comment;
      string GwasPopulationStructure_obj_id; 
      string GwasPopulationKinship_obj_id; 
      float pvaluecutoff;
   } GwasTopVariations; 
